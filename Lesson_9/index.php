...
// The 'new class implements ...' construct creates an object of an unnamed class on the fly. 
// The mock repository ($mockRepo) doesn't really do anything. 
// It effectively says: "Yes, yes, I saved everything," even though it simply printed text.
$mockRepo = new class implements OrderRepositoryInterface {

    // Why is this needed in real life scenarios? 
    // Imagine you are writing an automated test for OrderProcessor. 
    // If you use the real FileOrderRepository, every test run will create actual files on the disk. 
    // You would then have to delete them, manage file permissions, etc. 
    // That is slow and inconvenient.
    public function save(Cart $cart): void
    {
        echo "TEST PASSED: Save method called. Amount: X";
    }
};
